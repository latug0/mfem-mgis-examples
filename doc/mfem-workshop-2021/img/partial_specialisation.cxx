...
convertCorotationnalCauchyStressToSecondPiolaKirchhoffStress(const T& s,
  ...
  return {
      ...
      J *
          ...
          2,
      J *
          ((cste * s[2] * iU[4] + s[5] * iU[3] + cste * s[4] * iU[0]) * iU[5] +
           (s[4] * iU[3] + cste * s[5] * iU[1]) * iU[4] + s[3] * iU[3] * iU[3] +
           (2 * s[1] * iU[1] + 2 * s[0] * iU[0]) * iU[3] +
           2 * s[3] * iU[0] * iU[1]) /
          2,
      J *
          ((s[5] * iU[4] + cste * s[1] * iU[3] + cste * s[3] * iU[0]) * iU[5] +
           s[4] * iU[4] * iU[4] +
      ...
      J *
          (s[5] * iU[5] * iU[5] +
           (s[4] * iU[4] + s[3] * iU[3] + 2 * s[2] * iU[2] + 2 * s[1] * iU[1]) *
               iU[5] +
