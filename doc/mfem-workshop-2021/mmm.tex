...
\begin{frame}{Periodic
  ...
  \begin{block}{MFEM contributions \& coupling}
    \begin{itemize}
      ...
      \hspace*{8mm}\scalebox{0.8}{we made a public MFEM contribution to add capabilities} 
      \item Read/write MED I/O file format \scalebox{0.8}{(development is not publicly disclosed)}
  ...
  \begin{block}{Modelling inclusions at fuel pellet's microstructure scale}
    \hspace*{2cm}\includegraphics[height=4cm]{img/REV_2000inc.png}
  \end{block}
  \end{minipage}}
\begin{textblock}{.2}(0.73,0.62)
...
\begin{textblock}{.92}(0.02,0.11)
  ...
  \begin{block}{MFEM iterative solvers and preconditioners}
    \begin{itemize}
      ...
      \item Strong scaling benchmark (CEA/CCRT AMD Milan architecture). $400\ 10^6$ unknowns
    \end{itemize}
  \end{block}
  \end{minipage}}
\end{textblock}
\begin{textblock}{.98}(0.0,0.51)
\includegraphics[height=3.6cm]{ver/timer-r3.pdf}
\end{textblock}
\begin{textblock}{.98}(0.58,0.51)
\includegraphics[trim = .1cm .1cm 7.9cm .1cm,clip,height=3.6cm]{ver/speedup-r3.pdf}
\end{textblock}
\end{frame}
...
\begin{frame}{Phase-field modelling}
  \begin{block}{Modelling fuel pellet fragmentation during reactor start-up}
    \begin{itemize}
      ...
      \end{itemize}
      \item $132\ 10^6$\,nodes, $400\ 10^6$ unknowns, \textbf{2500} cores \scalebox{0.8}{(CEA/CCRT computing facility)}
    \end{itemize}
  \end{block}
