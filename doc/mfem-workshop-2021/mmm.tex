...
\begin{frame}{\scalebox{0.8}{Periodic
  ...
  \begin{block}{REV modelling in PLEIADES}
    \begin{itemize}
    \item Existing capabilities (not in \mmm{} yet)
    \begin{itemize}
      ...
      \item Typical scale of computational domain: 200 $\mu{}m$ - 1000 $\mu{}m$
...
\begin{minipage}{1.1\textwidth}
  \begin{itemize}
    ...
    \begin{itemize}
      \item Keep the trust of industrial partners (EDF, Framatome) on PLEIADES middleware
      \item Overall robustness of the code
      \item Setup extensive continuous integration, tutorials
  ...
  \end{itemize}
    \end{minipage}}
  \begin{textblock}{.2}(0.81,0.12)
%  \includegraphics[width=.94\textwidth]{img/ex1p-np100.png}
  \includegraphics[trim = 2.9cm .1cm 1.cm .1cm,clip,width=.94\textwidth]{ver/222_spheres.png}
  \end{textblock}
\end{frame}    
