...
\scalebox{0.8}{
  \begin{minipage}{14cm}
    ...
    \end{itemize}
\bigskip
    \item  Lesson learned from \texttt{Mfront} developped at CEA\\\hspace*{1cm}opensource since 2014
    \begin{itemize}
    ...
    \item extra work, need to book time for: minimal support, documentation, training
    \end{itemize}
  \end{itemize}
  \end{minipage}}
}
...
\begin{frame}[fragile]{The
  ...
  \begin{itemize}
    ...
    \end{itemize}
    \item Proposed improvements for \mmm{}:
    \begin{itemize}
    ...
    \item In practice:
    \begin{itemize}
      \item \mmm{} is a library made up of
      \begin{enumerate}
...
\begin{minipage}{1.1\textwidth}
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item Prediction and handling of the Dirichlet \\\hspace*{1cm}boundary
      conditions (critical).
