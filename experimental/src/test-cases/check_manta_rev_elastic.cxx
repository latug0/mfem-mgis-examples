...
namespace check_manta_rev_elastic {
  ...
  regular_solver_list build_solvers_list() {
    regular_solver_list res = {
        ...
        solver_name::HyprePCG,       solver_name::CGSolver,
        solver_name::BiCGSTABSolver, solver_name::MINRESSolver};
    return res;
  }
  ...
  regular_pc_list build_pc_list() {
    regular_pc_list res = {precond_name::HypreBoomerAMG, precond_name::HypreILU,
  ...
  void setup_properties(const TestParameters& p,
    ...
    problem.addBehaviourIntegrator("Mechanics", 2, p.library,
                                   "SaintVenantKirchhoffElasticity");
    // materials
