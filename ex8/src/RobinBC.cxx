/*!
 * \file   RobinBC.cxx
 * \brief  Implementation of the Robin boundary condition and its nonlinear form
...
namespace mfem_mgis {
  ...
  RobinNonlinearFormIntegrator::RobinNonlinearFormIntegrator(
      double h_, double T_inf_, mfem::GridFunction *u_disp_)
      : h_base(h_),
        T_inf(T_inf_),
  ...
  RobinBC::~RobinBC() {}  // end of ~RobinBC
